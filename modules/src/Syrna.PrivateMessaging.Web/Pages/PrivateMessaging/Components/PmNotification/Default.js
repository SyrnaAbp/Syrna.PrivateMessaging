$(function() {
    let pmService = syrna.privateMessaging.privateMessages.privateMessage;
    let notificationService = syrna.privateMessaging.privateMessageNotifications.privateMessageNotification;
